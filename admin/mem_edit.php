...
$row_member=mysqli_fetch_array($rs_member);
//echo $row_member['mem_name'];
            ...
            <div class="col-md-8">
              <form action="member_db.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" name="ref_l_id" id="ref_l_id" required>
                      <option value="<?php echo $row_member['ref_l_id']; ?>"><?php include 'mem_status.php'; ?></option>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="mem_name" class="form-control" id="mem_name" placeholder="" value="<?php echo $row_member['mem_name'];?>">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="" class="col-sm-2 col-form-label">Username </label>
                  <div class="col-sm-10">
                    <input type="text" name="mem_username" class="form-control" id="mem_username" placeholder="" value="<?php echo $row_member['mem_username'];?>">
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="mem_phone" class="form-control" id="mem_phone" placeholder="" value="<?php echo $row_member['mem_phone']; ?>">
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    ภาพเก่า<br>
                    <img src="../mem_img/<?php echo $row_member['mem_img'];?>" width="150px">
                    <input type="hidden" name="mem_img2" value="<?php echo $row_member['mem_img']; ?>">
                    <br><br>
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    ...
                    <br><br>
                    <img id="blah" src="#" alt="รูปภาพ" width="300" />
                  </div>
                </div>
